...
(monthly)](http://cranlogs.r-pkg.org/badges/kitesquare)](https://www.r-pkg.org/pkg/kitesquare)
[![CRAN RStudio mirror downloads
(total)](https://cranlogs.r-pkg.org/badges/grand-total/kitesquare)](https://www.r-pkg.org/pkg/kitesquare)
<!-- badges: end -->
...
patches, the higher the degree of statistical dependency between $X$ and
$Y$.
